...
async function boot() {
  ...
  for (const f of ["001_init.sql", "003_mail_settings.sql", "004_bi_reports.sql", "006_projects.sql", "007_directory_settings.sql", "008_project_authority.sql", "009_brand.sql", "010_project_team.sql"]) {
